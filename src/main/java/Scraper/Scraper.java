...
//		options.addArguments("headless");
		...
		WebElement tweetelement = wait.until(ExpectedConditions.presenceOfElementLocated(By.tagName("input")));
		tweetelement = tweetelement.findElement(By.xpath("//article/div/div/div"));
...
//		
//		out.setContent(parser.parseTweet(tweetcontent));
//		out.setRetweets(parser.parseStr(tweetretweets));
//		out.setLikes(parser.parseStr(tweetlikes));
//		
//		wc.close();
